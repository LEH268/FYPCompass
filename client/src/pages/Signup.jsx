...
export default function Signup() {
  ...
  const handleSignup = (e) => {
    e.preventDefault();
    // In a real application, you would handle API registration here.
    // After successful signup, redirect to login or directly to the dashboard.
    navigate("/login");
  };
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input 
                  type="email" 
                  required 
                  placeholder="id@imail.sunway.edu.my"
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 outline-none transition-all"
                />
              </div>
            </div>
