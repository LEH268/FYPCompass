...
export default function SupervisorStudentDetails() {
  ...
  const student = {
    ...
    progress: 35,
    email: `${id || "25001001"}@imail.sunway.edu.my`,
  ...
  const submissions = [
    {
      id: 101,
      name: "Oliver_Proposal_Final.pdf",
                  ...
                  <div className="p-5 bg-white flex flex-col sm:flex-row gap-4 sm:items-center justify-between border-b border-slate-100">
                    ...
                    <div className="flex flex-col gap-2 min-w-[140px]">
                      ...
                      {sub.status === 'Pending Review' && (
                        <button onClick={() => navigate('/supervisor/feedback')} className="flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold rounded-lg transition-colors shadow-sm">
