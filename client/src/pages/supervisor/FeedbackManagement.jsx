...
export default function FeedbackManagement() {
  ...
  const pendingItems = [
    { id: 1, name: "Oliver Smith", title: "Project Proposal", file: "FYP_Proposal_v2.pdf" },
    { id: 2, name: "Emma Johnson", title: "System Design Spec", file: "SDS_Draft_1.docx" },
  ];
    ...
    <div className="max-w-6xl mx-auto space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          <button onClick={() => navigate(-1)} className="p-2 mr-4 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors text-slate-600">
