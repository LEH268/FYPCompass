...
import { Users, FileSignature, CalendarCheck, AlertCircle, ArrowRight } from "lucide-react";
                ...
                <tr className="hover:bg-slate-50/50 transition-colors group">
                  ...
                  <td className="p-4 text-right pr-5">
                    <button 
                      ...
                      className="text-indigo-600 hover:text-white hover:bg-indigo-600 border border-transparent hover:border-indigo-600 px-3 py-1.5 rounded-lg font-semibold text-xs transition-colors"
                    >
                      Review
                    </button>
                  </td>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 flex flex-col">
          ...
          <div className="space-y-4 flex-1">
            <div className="p-4 border border-amber-200 bg-amber-50/50 rounded-xl hover:shadow-sm transition-all">
              ...
              >
                View Document <ArrowRight className="w-3 h-3 ml-1" />
              </button>
            </div>
          </div>
        </div>
