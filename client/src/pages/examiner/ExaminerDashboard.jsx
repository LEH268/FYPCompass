    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4">
        ...
        <button 
          ...
          className="bg-white border border-slate-300 text-slate-700 px-4 py-2 rounded-lg text-sm font-semibold shadow-sm hover:bg-slate-50 transition-colors flex items-center disabled:opacity-70 disabled:cursor-not-allowed"
        >
          {isDownloading ? (
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-sm divide-y divide-slate-100">
                <tr className="hover:bg-slate-50/50 transition-colors group cursor-pointer" onClick={() => navigate('/examiner/students/25008442')}>
                  <td className="p-4 pl-5">
                    <p className="font-bold text-slate-800 max-w-[200px] truncate mb-1">Healthcare AI Diagnosis</p>
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-rose-100 text-rose-700">Final Report</span>
                  </td>
                  <td className="p-4">
                  ...
                  <td className="p-4 text-right pr-5">
                    <button onClick={(e) => { e.stopPropagation(); navigate('/examiner/evaluations/25008442'); }} className="bg-purple-600 hover:bg-purple-700 text-white px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors shadow-sm w-full">
                      Grade Now
                    </button>
                  </td>
                </tr>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
          ...
          <div className="space-y-4">
            <div onClick={() => navigate('/examiner/students/24127094')} className="flex border border-purple-100 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow cursor-pointer">
              ...
              <div className="p-3 flex-1 bg-white">
                ...
                <p className="text-xs text-slate-400 mt-2 flex items-center"><MapPin className="w-3 h-3 mr-1 text-slate-400" /> Lab 3, Block C</p>
              </div>
            </div>
          </div>
        </div>
